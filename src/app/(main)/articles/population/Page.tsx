...
export default function PopulationPage() {
  ...
  return (
    <div className="container">
      ...
      <ArticleText>
        <p>
          「日本の人口が減っている」——そんな話は日常的に耳にします。しかし、どれくらいのスピードで、何が原因で減っているのか、そしてその規模がどれほどのものなのか、実感を持って理解するのは簡単ではありません。        </p>
        <p>
          2024年の1年間で、日本の総人口は<strong>58万人</strong>減少しました。この記事では、総人口の長期推移、出生数と死亡数が逆転した「自然減」の拡大、外国人の流入による「社会増」、そして主要都市の人口との比較を通じて、人口減少の現実を数字で紐解いていきます。
        </p>
      </ArticleText>
